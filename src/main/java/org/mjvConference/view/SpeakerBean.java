package org.mjvConference.view;
...
import org.mjvConference.model.Speaker;
...
public class SpeakerBean implements Serializable {
	...
	@PersistenceContext(unitName = "mjvConference-persistence-unit", type = PersistenceContextType.EXTENDED)
